...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2024 at 12:09 AM
...
CREATE TABLE `receipts` (
  ...
  `paymentMethod` enum('cash','gcash','other') NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `receipts`
  ADD CONSTRAINT `receipts_ibfk_1` FOREIGN KEY (`sellerID`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `receipts_ibfk_2` FOREIGN KEY (`studentID`) REFERENCES `users` (`id`);
